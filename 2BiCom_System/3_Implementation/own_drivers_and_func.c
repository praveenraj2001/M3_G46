...
/*This work is done by bashaboina Naresh, Varun S, Mantra G with help of Nyalam Praveenraj*/
// This work is done by bashaboina Naresh, Varun S, Mantra G with help of Nyalam Praveenraj
//  Here Pg.nos are refering to pg.nos in Technical Reference manual
...
{								// for time = 1000 this gives delay of approx 1sec
	...
	{
		un_used_var1++;
		un_used_var1 = un_used_var1 + (un_used_var1/2);
	}
}
